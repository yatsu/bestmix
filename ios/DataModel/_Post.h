...
@property (nonatomic, strong) NSNumber* mine;


@property BOOL mineValue;
- (BOOL)mineValue;
- (void)setMineValue:(BOOL)value_;

//- (BOOL)validateMine:(id*)value_ error:(NSError**)error_;
...
- (NSNumber*)primitiveMine;
- (void)setPrimitiveMine:(NSNumber*)value;
